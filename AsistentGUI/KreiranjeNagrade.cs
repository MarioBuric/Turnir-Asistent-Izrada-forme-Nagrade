...
namespace AsistentGUI
{
    public partial class KreiranjeNagrade : Form
    {
        ...
        private void lblOsvojenoMjesto_Click(object sender, EventArgs e)
        {

        }

        private void lblNazivNagrade_Click(object sender, EventArgs e)
        {
        ...
        private void lblPostotakNagrade_Click(object sender, EventArgs e)
        {

        }

        private void txtOsvojenoMjesto_TextChanged(object sender, EventArgs e)
        {
    ...
    {
        public static IEnumerable<IKonekcija> Konekcije { get; internal set; }
    }
}
